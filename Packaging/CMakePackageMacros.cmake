...
function(AddExecutableToPackage component destination executableName)
    install(PROGRAMS ${executable} DESTINATION ${destination})
endfunction()

function(AddLibraryToPackage component destination libraries)
    install(PROGRAMS ${executable} DESTINATION ${destination} COMPONENT ${CMAKE_SOURCE_DIR}/librariesOutput/${component})
endfunction()